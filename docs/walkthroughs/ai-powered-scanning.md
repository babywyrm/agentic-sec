...
# Results: 179 findings across 139 tools, 0.7s, zero API calls
```
...
Numbers above reflect a full camazotz deployment (139 tools). Results scale with server size.
...
2. **Show the delta.** "Static analysis found 179 issues across 139 tools. AI reasoning on the top 15 tools found 47 additional scenarios including live credential exposure and a persistent exfiltration backdoor." The diff output is ready-made for this — copy the NEW block directly into your report.
